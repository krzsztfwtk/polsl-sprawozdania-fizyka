...
- Na legendach do wykresów pojawia się zapis naukowy (np. `1.23e+04`). Lepiej używać zwykłego zapisu wykładniczego np.:
  $$ 1.23 \times 10^4 $$
...
Jeżeli potrzebujesz dedykowanej pomocy, przykładowych arkuszy Excela, dokumentów w Wordzie lub dodatkowych narzędzi np. do rysowania wykresów, 💵 napisz tutaj 💲:
